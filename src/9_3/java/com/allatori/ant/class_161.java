...
public class class_161 extends class_459 {
    ...
    public Class[] method_43() {
        ...
        clsArr[class_282.field_994.length] = UnsatisfiedLinkError.class;
    ...
    public class_161(int i) {
        super(ASMInterface.field_1301, i);
    }
}
